...
<div class="container">
    <form action="index.php?action=editComment&amp;id=<?= $affectedLine['id'] ?>" method="post">
        <div>
            <label for="id">Article numero</label> :<br/>
            <input type="text" id="postId" name="postId" value="<?= $affectedLine['post_id'] ?>" readonly="readonly"/>
        </div>
        <div>
